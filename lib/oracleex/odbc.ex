defmodule Oracleex.ODBC do
  ...
  It is used by `Oracleex.Protocol` and should not generally be
  accessed directly.
  """

  use GenServer

  alias Oracleex.Error
  ...
  def query(pid, statement, params, opts) do
    # Logger.info fn ->
    #   "#{inspect(pid)}: #{statement} #{inspect(params)} #{inspect(opts)}"
    # end
    ...
    if Process.alive?(pid) do
      ...
      {:error, %Oracleex.Error{message: :no_connection}}
    end
  end
