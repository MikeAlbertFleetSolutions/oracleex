...
RUN rm /opt/oracle/instantclient-sdk-linux.x64-12.2.0.1.0.zip
...
RUN rm /opt/oracle/instantclient-jdbc-linux.x64-12.2.0.1.0.zip
...
RUN rm /opt/oracle/instantclient-sqlplus-linux.x64-12.2.0.1.0.zip
...
RUN rm /opt/oracle/instantclient-odbc-linux.x64-12.2.0.1.0.zip
